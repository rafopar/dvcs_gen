...
int main(int argc, char *argv[])
{
  ...
  Int_t seed2=atoi(argv[2]);
    ...
    TGenDVCS *gEv=new TGenDVCS(5.7572,0,seed1,seed2); // P target
  //TGenDVCS *gEv=new TGenDVCS(5.7572,1,seed1,seed2); // N target
  //TGenDVCS *gEv=new TGenDVCS(5.7572,2,seed1,seed2); // D target
